...
const sections = [
  {
    ...
    body: [
      ...
      'All products, prices and ratings shown on UniSmart are real listings pointing to live merchant pages at the time of publishing. Always confirm the latest price, GST, shipping and warranty on the merchant’s website before you buy.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'Buying guides, comparisons, scores and reviews on UniSmart reflect our own editorial research and opinions. They are product discovery content for students — not professional, financial or purchasing advice.',
    ],
  },
  {
